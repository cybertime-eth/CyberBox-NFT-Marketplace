...
contract CeloPunks is ERC721Enumerable, Ownable {
    ...
    constructor(
        address _dev
        ) ERC721("CeloPunks", "cpunk") public {
        dev = _dev;
        setBaseURI("https://ipfs.io/ipfs/QmY66eL6S4HRwrPZo1SgoaP79esvzZ6455B6yFoZKnJJ2T/");
    }
